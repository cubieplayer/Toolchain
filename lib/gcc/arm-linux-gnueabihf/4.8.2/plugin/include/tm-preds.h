/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/cbuild/slaves/oorts/crosstool-ng/builds/arm-linux-gnueabihf-linux/.build/src/gcc-linaro-4.8-2013.06/gcc/config/arm/arm.md'.  */
